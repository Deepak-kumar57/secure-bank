...
-- ---------------------------------------------------------------------
-- 11. account_application  (customer account opening requests)
-- ---------------------------------------------------------------------
...
CREATE INDEX idx_application_user   ON account_application(user_id);
CREATE INDEX idx_application_status ON account_application(status);
